 ...
 * arch/riscv64_syscall.c's sys_ioctl comment) reading real commands
 * from real stdin (fd 0, the UART -- drivers/riscv64_serial.c's
 * serial_rx_ready/serial_getc, arch/riscv64_syscall.c's sys_read),
