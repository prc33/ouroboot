...
# riscv64-targeting TCC. The compatibility patch now contains only
# C-frontend/linker workarounds; musl's RISC-V assembly is built directly.
set -e
...
echo ""
echo "=== removing unused dynamic startup files ==="
echo "    crt/Scrt1.c/rcrt1.c: PIE/dynamic-executable crt startup variants,"
echo "    unused by this static-only build."
