...
| Compiler | 25,000 target; 20,000 stretch | 30,203 | Not yet attained |
...
This cleanup reduces compiler source by 246 lines overall (30,449 to 30,203).
...
| `target.h` | — | 141 | +141 | selected target definitions and backend contract |
...
| `tccelf.c` / `tccelf.h` | 2,506 | 2,658 | +152 | ELF sections, format, and linker API |
| `tcctools.c` | 317 | 270 | -47 | archive writer |
| `tcc.c` | 1,553 | 1,580 | +27 | compiler driver and dependency output |
| `tccpp.c` / `parsing.c` / `parsing.h` | 3,822 | 3,737 | -85 | preprocessor and shared token layer |
| `utils.c` / `utils.h` | 259 | 304 | +45 | memory, strings, and input buffers |
| `tcc.h` | 980 | 616 | -364 | remaining compiler-wide state/API |
