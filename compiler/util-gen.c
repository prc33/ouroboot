/* The register machine: allocation, spilling, and materialising a value
   ...
   implementations of this same interface in wasm/wasm-regalloc.c and
   never links this file. See registers.h. Everything target-neutral
   that used to sit alongside this (gaddrof, the bitfield helpers) stayed
   behind in registers.c, which every target still compiles. */
